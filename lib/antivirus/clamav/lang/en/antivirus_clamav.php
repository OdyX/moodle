...
$string['tcpsockethostdesc'] = 'Hostname (accessible from the Moodle server) at which the ClamAV daemon will answer';
$string['tcpsocketport'] = 'TCP socket port';
$string['tcpsocketportdesc'] = 'Port number (usually 3310)';
